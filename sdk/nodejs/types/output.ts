...
export interface ObjectstorageBucketLifecycleRule {
    abortIncompleteMultipartUpload?: outputs.ObjectstorageBucketLifecycleRuleAbortIncompleteMultipartUpload;
    expiration?: outputs.ObjectstorageBucketLifecycleRuleExpiration;
    filter?: outputs.ObjectstorageBucketLifecycleRuleFilter;
    id: string;
    noncurrentVersionExpiration?: outputs.ObjectstorageBucketLifecycleRuleNoncurrentVersionExpiration;
    noncurrentVersionTransitions?: outputs.ObjectstorageBucketLifecycleRuleNoncurrentVersionTransition[];
    prefix?: string;
    status?: string;
    transitions?: outputs.ObjectstorageBucketLifecycleRuleTransition[];
}
...
export interface ObjectstorageBucketLifecycleRuleFilter {
    and?: outputs.ObjectstorageBucketLifecycleRuleFilterAnd;
    objectSizeGreaterThan?: number;
    objectSizeLessThan?: number;
    prefix?: string;
    tag?: outputs.ObjectstorageBucketLifecycleRuleFilterTag;
}
...
export interface ObjectstorageBucketLifecycleRuleFilterAnd {
    ...
    objectSizeLessThan?: number;
    prefix?: string;
    tags?: outputs.ObjectstorageBucketLifecycleRuleFilterAndTag[];
}
