 ...
 * const exampleSecurityGroupIngressRule = new thalassa.SecurityGroupIngressRule("example", {
...
export interface SecurityGroupIngressRuleState {
     ...
     * List of ingress rules for the security group
     */
    rules?: pulumi.Input<pulumi.Input<inputs.SecurityGroupIngressRuleRule>[] | undefined>;
    /**
     * ID of the Security Group to manage ingress rules for
     */
