 ...
 * const exampleSecurityGroupEgressRule = new thalassa.SecurityGroupEgressRule("example", {
...
export interface SecurityGroupEgressRuleState {
     ...
     * List of egress rules for the security group
     */
    rules?: pulumi.Input<pulumi.Input<inputs.SecurityGroupEgressRuleRule>[] | undefined>;
    /**
     * ID of the Security Group to manage egress rules for
     */
