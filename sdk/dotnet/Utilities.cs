...
namespace Pulumi.Thalassa
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/sandervb2/pulumi-thalassa";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Thalassa.version.txt");
    ...
    internal sealed class ThalassaResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ThalassaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
