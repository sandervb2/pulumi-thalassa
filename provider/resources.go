...
import (
	...
	thalassa "github.com/thalassa-cloud/terraform-provider-thalassa/thalassa/provider" // Import the upstream provider

	"github.com/sandervb2/pulumi-thalassa/provider/pkg/version"
)
...
const (
	...
	mainPkg = "thalassa"
	// modules:
	mainMod = "index" // the thalassa module
)

//go:embed cmd/pulumi-resource-thalassa/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-thalassa/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-thalassa/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "thalassa", thalassa.Provider(),
		...
		// convention is to have a function at "github.com/thalassa-cloud/terraform-provider-thalassa/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(thalassa.New(version.Version)()),
		...
		Keywords:   []string{"thalassa", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/sandervb2/pulumi-thalassa/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("thalassa_", mainMod,
